...
client_test() ->
     ...
     ServerPubKey  = <<30,231,212,22,139,223,244,70,37,202,104,94,227,212,90,247,244,208,231,176,178,140,100,129,16,101,82,39,31,130,145,122>>,

     {ok, TcpSock} = gen_tcp:connect("localhost", 7000, [{active, once}, binary, {reuseaddr, true}], 1000),
% 7890, 
